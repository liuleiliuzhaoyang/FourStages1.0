...
Dates.orien = function(obj, pos){
    ...
    obj.style.top = rect.top + (pos ? 0 : Dates.scroll()) + 'px';
...
Dates.view = function(elem, options){
    ...
    if(!Dates.box){
        ...
        div.innerHTML =  log.html = '<div class="laydate_top">'
          +'<div class="p_rq_left_s">'
           +'<span class="p_left_radius1"></span>'
            +'&nbsp;收款日'
          +'</div>'
          +'<div class="p_rq_left_h">'
            +'<span class="p_left_radius2"></span>'
              +'&nbsp;还款日'
          +'</div>'
          +'<div class="laydate_ym laydate_y" id="laydate_YY">'
            +'<a class="laydate_choose laydate_chprev laydate_tab"><cite></cite></a>'
            +'<input id="laydate_y" readonly>'
        ...
        +'<div class="laydate_bottom">'
          ...
          +'<div class="laydate_btn">'
            +'<a id="laydate_clear"></a>'
            +'<a id="laydate_today"></a>'
            +'<a id="laydate_ok"></a>'
          +'</div>'
